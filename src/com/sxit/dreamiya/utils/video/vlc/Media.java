...
package com.sxit.dreamiya.utils.video.vlc;

import java.util.HashSet;
import java.util.Locale;

import com.sxit.dreamiya.utils.video.libvlc.LibVLC;
import com.sxit.dreamiya.utils.video.libvlc.LibVlcException;
import com.sxit.dreamiya.utils.video.libvlc.MediaList;
import com.sxit.dreamiya.utils.video.libvlc.TrackInfo;
import com.sxit.dreamiya.utils.video.libvlc.Util;
import com.sxit.dreamiya.utils.video.libvlc.VLCApplication;
...
public class Media implements Comparable<Media> {
    ...
    private void extractTrackInfo(TrackInfo[] tracks) {
        ...
        for (TrackInfo track : tracks) {
            if (track.Type == TrackInfo.TYPE_VIDEO) {
                ...
                mTitle = track.Title;
				// mArtist = Util.getValue(track.Artist,
    ...
    public String getGenre() {
		...
		// return mGenre;
		// else if( mGenre.length() > 1)/* Make genres case insensitive via
		// normalisation */
