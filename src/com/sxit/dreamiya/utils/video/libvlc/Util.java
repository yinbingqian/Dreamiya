...
public class Util {
    ...
    public static void updateLibVlcSettings(SharedPreferences pref) {
        ...
        System.out.println("enable_frame_skip:true");
    ...
    public static String readAsset(String assetName, String defaultS) {
        try {
            InputStream is = DemoApplication.getAppResources().getAssets().open(assetName);
    ...
    public static String getValue(String string, int defaultId)
    {
        return (string != null && string.length() > 0) ?
                string : DemoApplication.getAppContext().getString(defaultId);
    }

    public static int convertPxToDp(int px) {
        WindowManager wm = (WindowManager)DemoApplication.getAppContext().
    ...
    public static int convertDpToPx(int dp) {
        return Math.round(
                ...
                DemoApplication.getAppResources().getDisplayMetrics())
                         );
    }
    ...
    public static boolean isPhone(){
        TelephonyManager manager = (TelephonyManager)DemoApplication.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String[] getCustomDirectories() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(DemoApplication.getAppContext());
