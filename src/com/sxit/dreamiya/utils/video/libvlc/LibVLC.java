...
public class LibVLC {
    ...
    public void readMediaML(String mrl) {
        readMediaML(mLibVlcInstance, mrl, false);
    }

    /**
     * Read a media.
     */
    public int readMediaML(String mrl, boolean novideo) {
        Log.v(TAG, "Reading " + mrl);
        return readMediaML(mLibVlcInstance, mrl, novideo);
    }
     ...
     */
    private native int readMediaML(long instance, String mrl, boolean novideo);
